...
const pt = {
  ...
  crew: {
    ...
    gateEyebrow: 'Peraí',
    gateTitle: 'O time Bold não para no Miguel, continua rolando',
    gateButton: 'Ver o time completo',
    members: {
  ...
  cases: {
    ...
    gateEyebrow: 'Peraí',
    gateTitle: 'Ainda tem case bom que você não viu',
    gateButton: 'Ver todos os cases',
  },
  clientes: {
    eyebrow: 'Clientes',

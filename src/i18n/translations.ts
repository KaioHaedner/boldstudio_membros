...
const pt = {
  ...
  processo: {
    ...
    // texto de apoio embaixo do nome da etapa; vazio onde não existe
    etapasApoio: [
      'Levantamento de necessidade',
      '',
      'Briefing, grupo do WhatsApp e alinhamento',
      '',
      '',
      '',
...
const en: Dict = {
  ...
  processo: {
    ...
    etapasApoio: [
      'Needs assessment',
      '',
      'Briefing, WhatsApp group and alignment',
      '',
      '',
      '',
      'Pre-Production Meeting',
...
const es: Dict = {
  ...
  processo: {
    ...
    etapasApoio: [
      ...
      '',
      'Briefing, grupo de WhatsApp y alineación',
      '',
      '',
      '',
      'Pre-Production Meeting',

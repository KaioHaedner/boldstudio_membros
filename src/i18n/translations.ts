...
const pt = {
  ...
  processo: {
    ...
    counters: ['Marcas atendidas', 'Projetos entregues', 'Reconhecimentos', 'Clientes satisfeitos', 'Vídeos produzidos', 'Retenção de clientes'],
...
const en: Dict = {
  ...
  processo: {
    ...
    counters: ['Brands served', 'Projects delivered', 'Awards', 'Satisfied clients', 'Videos produced', 'Client retention'],
...
const es: Dict = {
  ...
  processo: {
    ...
    counters: ['Marcas atendidas', 'Proyectos entregados', 'Reconocimientos', 'Clientes satisfechos', 'Videos producidos', 'Retención de clientes'],

    ...
    <div ref={rootRef} className="relative isolate min-h-screen bg-bold-black text-bold-white">
      ...
      <main className={mainClass}>
        ...
        >
          ...
          {/* No celular cada palavra ocupa uma linha e a frase toma a tela
              quase inteira; a partir do sm volta a quebrar naturalmente. */}
          <h2 className="nascida-frase relative z-10 font-extrabold leading-[0.9] text-bold-white">
            {t.nascida.lineA}
          </h2>
          <span className="sticker-amarelo nascida-destaque relative z-10 mt-3 inline-block rounded-xl px-5 py-1.5 font-black italic tracking-[-0.03em] text-bold-black sm:mt-4">
            {t.nascida.highlight}
          </span>
        </section>
